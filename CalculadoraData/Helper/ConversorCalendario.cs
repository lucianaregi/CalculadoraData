...
namespace CalculadoraData.Helper
{
    public static class ConversorCalendario
    {
        /// <summary>
        /// Operação de soma
        /// </summary>
        ...
        /// <returns></returns>
        public static double DateToJD(int year, int month, int day, int hour, int minute, string op, long alterDate)
        {
         ...
         public static double JulianDate(int year, int month, int day, int hour, int minute, string alterDate, long plusMinutes)
        {
        ...
        /// <returns></returns>
        public static string JulianToGregorian(double julianDate)
        {
            julianDate += .5;
